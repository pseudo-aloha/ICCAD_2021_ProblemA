...
nand NAND2_119(G495, G408, G420); //rewire  G409 4
...
nand NAND2_125(G513, G409, G421); //rewire  G420 3
...
xnor NAND2_257(G797, G645, G773); //type changed
...
not NOT_4(G942,G847);
not NOT_5(G943,G873);
not NOT_6(G944, G912); //rewire  G834 3
not NOT_7(G945,G860);
not NOT_8(G946,G873);
not NOT_9(G947,G847);
...
not NOT_27(G965, G834); //rewire  G912 3
...
nor NAND2_326(G1234, G4, G1141); //type changed
