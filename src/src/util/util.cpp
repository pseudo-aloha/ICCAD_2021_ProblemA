...
extern Timer timer_cutSearching;
extern Timer timer_similarity;
extern Timer timer_CF_proving;
extern Timer timer_CF_fraig;
...
reportTimers()
{
	...
	timer_cutSearching.report();
	timer_similarity.report();
	timer_CF_proving.report();
	timer_CF_fraig.report();
